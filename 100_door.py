...
#
#  The first time through, visit every door and  toggle  the door  (if the door
#  is closed,  open it;   if it is open,  close it).
#
#  The second time, only visit every 2nd door   (door #2, #4, #6, ...),
#  and toggle it.
#
#  The third time, visit every 3rd door   (door #3, #6, #9, ...), etc,   until
