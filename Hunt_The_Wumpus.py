...
class WumpusGame(object):
    ...
    def __init__(self, edges=[]):
        ...
        # (see the end of the script for example).
        if edges:
            cave = {}
        ...
        # If no edges are specified, play in the standard cave: a dodecahedron.
            ...
            cave = {1: [2, 3, 4], 2: [1, 5, 6], 3: [1, 7, 8],
                    4: [1, 9, 10], 5: [2, 9, 11], 6: [2, 7, 12],
                    7: [3, 6, 13], 8: [3, 10, 14], 9: [4, 5, 15],
                    10: [4, 8, 16], 11: [5, 12, 17], 12: [6, 11, 18],
                    13: [7, 14, 18], 14: [8, 13, 19], 15: [9, 16, 17],
                    16: [10, 15, 19], 17: [11, 20, 15], 18: [12, 13, 20],
        ...
        # As in the original game. I don't like this choice:
    ...
    def breadth_first_search(self, source, target, max_depth=5):
        ...
        def search(stack, visited, target, depth):
            ...
            stack = list(set([graph[v][i] for v in stack for i in range(
                len(graph[v]))]).difference(visited))
            depth += 1
    ...
    def get_players_input(self):
        ...
        while 1:								# Query the action.
            ...
            # Ensure that the player choses a valid action (shoot or move)
            try:
                mode = str(inpt).lower()
        ...
        while 1:  # Query the target of the action.
            ...
            try:  # Ensure that the chosen target is convertable to an integer.
                ...
                # Restart the while loop, to get a valid integer as target.
                continue
    ...
    def enter_room(self, room_number):
        ...
        # Only if nothing else happens, the player enters the room of his
        # choice.
        return room_number
    ...
    def shoot_room(self, room_number):
        ...
        # If you shoot into another room, the Wumpus has a 75% of chance of
        # waking up and moving into an adjacent room.
    ...
    def gameloop(self):
        ...
        while 1:
            ...
            print("Tunnels lead to:  {0}  {1}  {2}".format(
                *self.cave[self.player_pos]))
            ...
            # E.g. Deadly threat, quiver empty, etc.
...
if __name__ == '__main__':
    ...
    # TODO: In the original game you can replay a dungeon (same positions of
    # you and the threats)
